...
export default function CallScreen({ setScreen, screens, roomId }) {
  ...
  const startLocalStream = async () => {
    ...
    console.log("Connetion ==>",constraints);
    const newStream = await mediaDevices.getUserMedia(constraints);
    console.log("Connetion ==> newStream",newStream);
  ...
  const startCall = async id => {
    ...
    console.log("call screen iddd==>",id);
    const roomRef = await db.collection('rooms').doc(id);
    console.log("call screen roomref==>",roomRef);
